...
class Bebop_functions():
    def __init__(self):
        ...
        self.controlX = PID(0.6, 0.1, 1.5)  # PID(0.8, 0.001, 1.5)
...
if __name__ == '__main__':
    try:
        ...
        # command = "rosbag record -a -x /bebop/states/common/CommonState/BatteryStateChanged -O {}".format(str(UNIQUE_ID))  # bebop/image_raw
